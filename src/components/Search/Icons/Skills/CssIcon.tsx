...
function IconLogoCss3(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 512 512" fill="currentColor" {...props} className={styles['iconsSkills']}>
